    ...
    if (kIsWeb && widget.trailerKey.isNotEmpty) {
      ...
      ui_web.platformViewRegistry.registerViewFactory(
        ...
        (int viewId) => html.IFrameElement()
          ..src = widget.trailerKey.startsWith('http')
              ? widget.trailerKey
              : 'https://www.youtube-nocookie.com/embed/${widget.trailerKey}?autoplay=1&mute=0&controls=1&modestbranding=1&rel=0&enablejsapi=1&start=${widget.startSeconds}'
          ..style.border = 'none'
          ..style.width = '100%'
          ..style.height = '100%'
